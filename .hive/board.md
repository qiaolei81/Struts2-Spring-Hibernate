...
- 🔄 `t21` **Re-run all integration and E2E tests: verify all 22 contract tests pass, remove @Disabled from PmVerificationScenariosTest and confirm all 7 PM scenarios pass, prove login-to-CRUD flow end-to-end** (tester) - in_progress
- ⏳ `t22` **Final feature parity sign-off: validate all acceptance criteria from t2 inventory are met, confirm all user flows work end-to-end, and grant rewrite acceptance** (pm) - pending
